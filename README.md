...
| Datei | Beschreibung |
|---|---|
| `20260922_LibreLinkUp_RE_Public.pdf` | Der vollständige Bericht als PDF — vorangestellter Krypto-Primer („Teil 0") + Hauptbericht. |
| `20260922_LibreLinkUp_RE_Public_EN.pdf` | Dieselbe Fassung auf englisch. |
